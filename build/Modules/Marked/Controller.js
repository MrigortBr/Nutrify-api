...
let MarkedController = class MarkedController {
    ...
    getMarkedPosts(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const response = yield this.service.getMarkedPosts(req.params.username, ((_a = req.user) === null || _a === void 0 ? void 0 : _a.id) || 0);
...
], MarkedController.prototype, "getMarkedPosts", null);
MarkedController = __decorate([
    (0, routerDecorator_1.Controller)("/marked"),
    __metadata("design:paramtypes", [])
], MarkedController);
exports.default = MarkedController;
