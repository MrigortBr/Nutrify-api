...
let AuthenticateController = class AuthenticateController {
    constructor() {
        this.service = new Service_1.AuthenticateService();
    }
    loginRoute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { email, password } = req.body;
                const response = yield this.service.login(email, password);
    ...
    register(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.service.register(name, email, password);
                res.json(response).status(response.statusCode);
            }
            catch (error) {
                next(error);
...
__decorate([
    (0, routerDecorator_1.Post)("/login"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], AuthenticateController.prototype, "loginRoute", null);
__decorate([
    (0, routerDecorator_1.Post)("/register"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], AuthenticateController.prototype, "register", null);
exports.AuthenticateController = AuthenticateController = __decorate([
    (0, routerDecorator_1.Controller)("/user"),
